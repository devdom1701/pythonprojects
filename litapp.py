...
food_details = {
    ...
    "Pork Carnitas": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Pork Carnitas, thats just the Description you're good."},
    "Pasta w/ Meat Sauce": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Pasta with cool sauce on it."},
    "Loaded Potato Wedges": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Loaded Potato wedges, Thats it."},
    "Chicken Nuggets": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Chicken with nuggies."},
    "Grilled Cheese": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Cheese but on the grill"},
    "Brisket and Potato Bowl": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "           "},
    "Chicken Strips": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Chicken but it strips."},
    "Cheeseburger Waffle Fries": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Burger but with waffles by it"},
    "Cheese Rippers": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Cheese but grim ripper"},
    "BBQ Pork Sandwich": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "BB Pork with no Q also its a sandwitch"},
    "Cheese Ravioli w/ Meat Sauce": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Tasty meat."},
    "Philly Cheesesteak": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "Cheesesteak but Philly(I dont care if it originated in Philly)"},
    "Ravioli": {"image": "https://i.imgur.com/5gawijE.jpeg", "Description": "An italian delecasy suited for only the finest in sociotey, those who taste it initally for the first time in their lives will explode and be in shock and awe at the sheer desnsity of the pasta inside this elegant, but simple dish; although to the untrained eye it may seem a contrevertial or irrelevant food, However the ravioli is just the dish for your sad saturday morning."},
