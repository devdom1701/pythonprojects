...
def shop(armour,shopvisitcount):
    global gold,buff,bopbought,dirtarmourbuff,silverarmourbuff,goldarmourbuff,dragonarmourbuff,morbiusarmourbuff
    print("________________________________")
...
skilluse = 0
def boss1():
    global buff,roundhp,attkopt,skillopt,armour,attkdmg,skilldmg,boss1defeated,plrhp
    roundhp = 100
