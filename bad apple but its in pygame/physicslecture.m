...
fields - used to explain electronic and magnetic forces (like a geometrical plane)
  - Fields can have energy, even if it doesnt have waves (Static fields)
    - Static fields have contain Quantum flux, which still have energy (Dark energy)
  ...
  - Fields fill all of space in which they inhabit
    ...
    - However, light is also made of photons; points
...
`
      - Then how can a point (particle) spread out like a wave?
        Q: How can one drag their hand through a pond, 
            but also be dropping rocks into the pond 
                    at the same moment?

            A: 'This is the only real mystery of physics'
`
    - Antiparticles: every particle has its antiparticle, but few are their own antiparticle
         - has the same mass as their matter counterparts
         - when in contact with particles, they annihate eachother and produce energy and photons

    - Quantum field theory: fields can have waves, waves are the same thing as paricles, matter is made of atoms,etc.

    (Arrows are 'understandings' and how each topic helps understand the other)
    ...
    Forces < - - Particles - > Matter
        ...
        - Quantum fields use matter and force to find the origin of the movement

    Waves and particles are disturbances (excitations) of fields [as in Excited, exciting]
    Ex: 
        wave excitations: drawing your finger through a pond; 
        particle excitations: dropping a rock into a pond


    ---------------------------------------------------------------------------------------------------
All known fields and particles:
    ---------------------------------------------------------------------------------------------------
        - Bosons:
...
~ --- ~ The Classification of Stuff (matter) ~ --- ~ 

        Ordinary matter (4% of the universe)
            - atoms, molecules, ion

        Radiation (<<1% of energy in the universe, interestingly, accounts for the majority of particles)
        ...
        Dark energy (70% of the energy in the universe)
            - NOT Particles
                - The energy in a static field (an empty pond)


~ --- ~ Expansion of the universe and its effects on matter ~ --- ~
        ...
        Dark Energy: Energy density is unaffected by the expansion, the amount of dark energy actually increases!!

~ --- ~ Particle interactions: pair creation, annihilation and particle decay ~ --- ~
        ...
        - A particle and its "anti"-conterpart come together to annihate eachother and releases a light photon and massive energy
...
~ --- ~ Antimatter and the Big Bang~ --- ~
    ...
    - For every proton there are 10^10 photons and 10^10 neutrinos
        - but there are almost no antiprotons or antielectrons around
    - Because the universe was so hot (10^16 degrees), a collision of particles could create a pair creation
        ...
        Even though some particles would  decay, their number would have been replenished by a pair creation
            - because the temperature was high enough to do that
